        ...
        <div className="max-w-lg mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="flex items-center gap-1 text-[11px] text-white/70 justify-end">
                <MapPin className="w-3 h-3 text-[#58BB43]" />
                <span className="capitalize">{mesaLabel}</span>
              </div>
              <div className="flex items-center gap-1 text-[11px] text-white/50 justify-end">
