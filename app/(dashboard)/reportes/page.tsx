      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card-lg p-5 space-y-4">
          ...
          <div className="space-y-3">
            {[
              { label: 'Platos de Fondo', pct: 45, color: 'bg-brand' },
              { label: 'Entradas',        pct: 30, color: 'bg-brand-hover' },
        ...
        <div className="card-lg p-5 space-y-4">
          ...
          <div className="flex justify-between items-end h-28 pt-2">
            {[
              { h: 'h-10',     color: 'bg-slate-200',   label: '1pm' },
              { h: 'h-24',     color: 'bg-brand',        label: '2pm' },
              { h: 'h-16',     color: 'bg-slate-200',   label: '3pm' },
              { h: 'h-8',      color: 'bg-slate-200',   label: '4pm' },
              { h: 'h-20',     color: 'bg-emerald-500', label: '8pm' },
              { h: 'h-[88px]', color: 'bg-brand-hover', label: '9pm' },
            ].map(bar => (
