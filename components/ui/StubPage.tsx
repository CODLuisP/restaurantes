...
export default function StubPage({ section }: StubPageProps) {
  ...
  return (
    <div className="bg-slate-200 p-10 rounded-2xl border border-slate-300 text-center space-y-4 max-w-xl mx-auto my-12 animate-section">
      <div className="p-3 bg-[#007542]/5 text-[#007542] w-max mx-auto rounded-full">
      ...
      <div className="bg-slate-100 p-4 rounded-xl text-left border border-slate-300">
