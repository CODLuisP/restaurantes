...
export default function Login() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FCFDFC] text-gray-800 flex flex-col justify-between relative overflow-x-hidden selection:bg-[#007542] selection:text-white">

      {/* Fondo grid sutil */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#007542]/5 via-transparent to-transparent pointer-events-none" />
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#eef4f1_1px,transparent_1px),linear-gradient(to_bottom,#eef4f1_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)] pointer-events-none opacity-40" />

      <div className="w-full flex-grow grid md:grid-cols-12 relative z-10 min-h-screen">

        {/* ── Panel izquierdo ─────────────────────────── */}
        <div className="md:col-span-6 bg-[#005e34] text-white flex flex-col justify-between relative overflow-hidden min-h-[400px] md:min-h-screen">
          ...
          <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_center,_#58BB43_2px,transparent_2px)] bg-[size:24px_24px]" />
          <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-[#007542] opacity-40 blur-3xl pointer-events-none" />
          <div className="absolute -top-10 -right-10 w-40 h-40 rounded-full bg-[#3AA346] opacity-30 blur-2xl pointer-events-none" />

          <div className="relative z-10 px-12 md:px-16 flex flex-col justify-center h-full gap-8 py-12">
            ...
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center backdrop-blur-md border border-white/20">
                <Utensils className="w-5 h-5 text-[#58BB43]" />
              </div>
              <span className="font-semibold tracking-wider text-sm uppercase text-emerald-100">RestoPro Perú</span>
            </div>

            <div>
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight leading-none mb-3">
            ...
            <div className="pt-6 pb-4 border-t border-white/15">
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  ...
                  <span className="text-xs font-medium flex items-center gap-1">
                    <MapPin className="w-3.5 h-3.5 text-[#58BB43]" /> Lima, Perú
                  </span>
                </div>
                <div>
                  ...
                  <span className="text-xs font-mono font-medium flex items-center gap-1">
                    <Clock className="w-3.5 h-3.5 text-[#58BB43]" /> {time || '08:15 AM'}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  { icon: <Layers     className="w-3.5 h-3.5 text-[#58BB43] shrink-0" />, title: 'Mesas & Comandas Digitales',  desc: 'Envío inmediato a barra e impresoras de cocina con estados de preparación automatizados.' },
                  { icon: <CreditCard className="w-3.5 h-3.5 text-[#58BB43] shrink-0" />, title: 'Facturación & Caja Integrada', desc: 'Emisión instantánea de Boletas, Facturas y notas de crédito homologadas directamente con SUNAT.' },
                  { icon: <ChefHat    className="w-3.5 h-3.5 text-[#58BB43] shrink-0" />, title: 'Control de Insumos & Recetas', desc: 'Sustracción automatizada de insumos según comanda enviada para evitar quiebres de cocina.' },
                  { icon: <TrendingUp className="w-3.5 h-3.5 text-[#58BB43] shrink-0" />, title: 'Métricas & Reportes de Venta', desc: 'Análisis pormenorizado de platos más rentables, mermas registradas e ingresos por turno de mozos.' },
                ].map(item => (
                  <div key={item.title} className="p-2.5 bg-white/5 rounded-lg border border-white/10 flex flex-col gap-1.5">
                    <div className="flex items-center gap-1.5">
                      {item.icon}
                      <span className="text-[12px] font-semibold text-gray-100 leading-tight">{item.title}</span>
                    </div>
                    <p className="text-[10px] text-emerald-50 opacity-65 leading-snug">{item.desc}</p>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="md:col-span-6 p-8 md:p-16 flex flex-col justify-center bg-[#F0F2F1] min-h-[500px]">
          <div className="w-full max-w-md mx-auto">
            <AnimatePresence mode="wait">
              ...
              {!isSuccess ? (
                ...
                >
                  <div className="mb-6">
                    <span className="text-xs font-bold text-[#007542]   py-0.5 rounded-full uppercase tracking-wider inline-block mb-2">
                      Acceso Autorizado
                    </span>
                  ...
                  <div className="grid grid-cols-2 bg-[#007542]/10 p-1 rounded-lg mb-6">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    {loginMethod === 'email' ? (
                      <div className="space-y-3.5">
                        <div>
                          <label className="block text-xs font-medium text-gray-650 mb-1">Correo Electrónico</label>
                          <div className="relative">
                            <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-450" />
                            <input type="email" placeholder="usuario@restopro.pe" value={email}
                              ...
                              className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-[#007542] focus:ring-2 focus:ring-[#007542]/10 transition-colors" />
                          </div>
                        </div>
                        <div>
                          <div className="flex justify-between items-center mb-1">
                            <label className="block text-xs font-medium text-gray-650">Contraseña</label>
                            <button type="button"
                              onClick={() => alert('Se ha enviado una solicitud a sistemas para restablecer la contraseña. Revise su bandeja de entrada.')}
                              className="text-[11px] text-[#007542] hover:text-[#1E8C45] hover:underline transition-all">
                              ¿Olvidó su clave?
                            </button>
                          </div>
                          <div className="relative">
                            <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-450" />
                            <input type={showPassword ? 'text' : 'password'} placeholder="••••••••••••" value={password}
                              onChange={e => { setPassword(e.target.value); if (errorMessage) setErrorMessage(null); }}
                              className="w-full pl-9 pr-10 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-[#007542] focus:ring-2 focus:ring-[#007542]/10 transition-colors" />
                      ...
                      <div className="space-y-4">
                        <div className="text-center">
                          ...
                          <div className="flex justify-center gap-3.5 my-2.5">
                            {[0,1,2,3].map(i => (
                              <div key={i} className={`w-4 h-4 rounded-full border-2 transition-all duration-150 ${pin[i] ? 'bg-[#007542] border-[#007542] scale-110' : 'bg-gray-100 border-gray-300'}`} />
                            ))}
                          </div>
                        </div>
                        <div className="grid grid-cols-3 gap-2 max-w-xs mx-auto">
                          {['1','2','3','4','5','6','7','8','9'].map(d => (
                            <button key={d} type="button"
                              ...
                              className="py-2 text-base font-semibold bg-gray-50 hover:bg-[#007542]/10 hover:text-[#007542] border border-gray-150 rounded-lg transition-colors active:scale-95">
                              {d}
                            </button>
                          ))}
                          <button type="button" onClick={handleClearPin}
                            className="py-2 text-xs font-medium text-gray-50 bg-[#d10d2d] hover:bg-[#d90429]/80 rounded-lg transition-colors active:scale-95">
                            Limpiar
                          </button>
                          ...
                          <button type="button" onClick={handlePinBackspace}
                            className="py-2 text-gray-100 bg-[#343a40] hover:bg-gray-600 rounded-lg transition-colors active:scale-95 flex items-center justify-center">
                      ...
                      <div className="flex items-center justify-between pt-0.5">
                        <label className="flex items-center gap-2 select-none cursor-pointer">
                          <input type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)}
                            className="rounded border-gray-300 text-[#007542] focus:ring-[#007542] w-4 h-4" />
                    ...
                    <button type="submit" disabled={isLoading}
                      className="w-full mt-4 bg-[#007542] hover:bg-[#1E8C45] text-white py-2.5 px-4 rounded-lg font-medium text-xs transition-all duration-150 focus:ring-4 focus:ring-[#007542]/20 flex items-center justify-center gap-2 cursor-pointer shadow-md disabled:bg-gray-300 disabled:cursor-not-allowed">
                      {isLoading
                ...
                <motion.div key="success-container" initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.95 }} className="text-center py-4">
                  <div className="w-16 h-16 rounded-full bg-[#007542]/10 text-[#007542] flex items-center justify-center mx-auto mb-4 border-2 border-[#58BB43]/20">
                  ...
                  <div className="my-6 bg-gray-50 p-5 rounded-xl border border-gray-150 text-left max-w-md mx-auto space-y-4">
                    <div className="flex items-center gap-3 pb-3 border-b border-gray-200">
                      <div className="w-10 h-10 rounded-full bg-[#007542] text-white flex items-center justify-center font-bold text-sm tracking-widest shadow-inner">
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs">
                      ...
                      <div className="bg-white p-2.5 rounded border border-gray-100">
                        ...
                        <span className="font-semibold text-[#005e34] flex items-center gap-1">
                      ...
                      <div className="bg-white p-2.5 rounded border border-gray-100">
                        ...
                        <span className="font-semibold text-[#3AA346]">S/. 12,450.00</span>
                      </div>
                      <div className="bg-white p-2.5 rounded border border-gray-100">
                    ...
                    <div className="pt-2">
                      ...
                      <div className="grid grid-cols-3 gap-1.5 text-[10px]">
                        <div className="px-2 py-1 bg-[#007542]/5 text-[#007542] rounded font-medium border border-[#007542]/10 text-center">Mesas & Salones</div>
                        <div className="px-2 py-1 bg-[#1E8C45]/5 text-[#1E8C45] rounded font-medium border border-[#1E8C45]/10 text-center">Comandas & Kitchen</div>
                        <div className="px-2 py-1 bg-[#3AA346]/5 text-[#3AA346] rounded font-medium border border-[#3AA346]/10 text-center">Factura SUNAT</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2 max-w-xs mx-auto">
                    <button onClick={() => router.push('/dashboard')}
                      className="w-full bg-[#007542] hover:bg-[#1E8C45] text-white py-2 px-4 rounded-lg font-medium text-xs transition-all flex items-center justify-center gap-2 cursor-pointer shadow">
