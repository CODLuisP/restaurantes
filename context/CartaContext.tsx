...
const defaultCarta: CartaDelDia = {
  ...
  active: true,
  items: [
    { id: 'mc1',  name: 'Ceviche Clásico Carretillero',   price: 39.50, category: 'Entradas',        description: 'Pescado fresco marinado en limón con ají limo, cebolla y choclo.',  available: true,  image: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?auto=format&fit=crop&q=80&w=400' },
    ...
    { id: 'mc4',  name: 'Lomo Saltado con Papas',          price: 45.00, category: 'Platos de fondo', description: 'Trozos de lomo fino salteados con cebolla, tomate y papas fritas.',  available: true,  image: 'https://images.unsplash.com/photo-1600891964599-f61ba0e24092?auto=format&fit=crop&q=80&w=400' },
    { id: 'mc5',  name: 'Ají de Gallina de la Abuela',     price: 34.00, category: 'Platos de fondo', description: 'Pollo deshilachado en salsa de ají amarillo con arroz y papa.',      available: true,  image: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?auto=format&fit=crop&q=80&w=400' },
    { id: 'mc6',  name: 'Arroz con Mariscos Meloso',       price: 42.00, category: 'Platos de fondo', description: 'Arroz meloso con mariscos frescos y culantro.',                      available: true,  image: 'https://images.unsplash.com/photo-1534080391025-09795117f05b?auto=format&fit=crop&q=80&w=400' },
    ...
    { id: 'mc9',  name: 'Suspiro a la Limeña',             price: 16.00, category: 'Postres',         description: 'Manjar blanco coronado con merengue al oporto.',                     available: true,  image: 'https://images.unsplash.com/photo-1587314168485-3236d6710814?auto=format&fit=crop&q=80&w=400' },
    ...
    { id: 'mc11', name: 'Súper Combo Marino (2 pers.)',    price: 78.00, category: 'Promociones',     description: 'Ceviche + arroz con mariscos + jarra de chicha para compartir.',     available: true,  image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?auto=format&fit=crop&q=80&w=400' },
  ],
};
